...
Type `!xg [space]` followed by one of the available transformations:
  ...
  - `colors`  swap Blue and Red
  - `mirror`  switch Left and Righthand mode
...
- You may wish to ask the streamer what their limits are set to. Choose to stay within them.
- Know that your requests may be auto-rejected or turned down by the person playing and it is ok.
